 ...
 * @generated
 */
public class UserManagementPackageImpl extends EPackageImpl implements UserManagementPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass userContainerEClass = null;
	 ...
	 * @see com.self.om.userManagement.UserManagementPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UserManagementPackageImpl() {
		super(eNS_URI, UserManagementFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link UserManagementPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static UserManagementPackage init() {
		if (isInited) return (UserManagementPackage)EPackage.Registry.INSTANCE.getEPackage(UserManagementPackage.eNS_URI);

		// Obtain or create and register package
		UserManagementPackageImpl theUserManagementPackage = (UserManagementPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof UserManagementPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new UserManagementPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theUserManagementPackage.createPackageContents();

		// Initialize created meta-data
		theUserManagementPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theUserManagementPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(UserManagementPackage.eNS_URI, theUserManagementPackage);
		return theUserManagementPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getUserContainer() {
		return userContainerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getUserContainer_Users() {
		return (EReference)userContainerEClass.getEStructuralFeatures().get(0);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUser_Password(), ecorePackage.getEByteArray(), "password", null, 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
